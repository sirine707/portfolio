...
import CertificateCard from "../cards/ProjectCards/Certificate-Card/CertificateCard";
...
function CertificatesCardSlider({ certificatesList = [], onCertificateClick }) {
        ...
        <div className="flex shrink-0 basis-full flex-nowrap gap-1 overflow-x-auto md:flex-row lg:gap-2">
          ...
          >
            {certificatesList.map((certificate, i) => (
              <SwiperSlide key={`${certificate.title}_${i}`}>
                <CertificateCard
...
export default CertificatesCardSlider;
